...
stack update
stack install --resolver lts-16.3 array bytestring containers deepseq hashable heaps io-streams lens mutable-containers mtl random strict text transformers vector vector-algorithms word8
